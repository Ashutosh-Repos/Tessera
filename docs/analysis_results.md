...
| **Atomic S3 Writes**      | Direct upload to final `.ts` key via single atomic `PutObject` — prevents partial/corrupt outputs and avoids copy/delete overhead                                                           | [executor.go](file:///Users/ashutoshkumar/Desktop/Apple%20Project/internal/worker/executor.go)                                                                                                                                                                                                                                                                                                         |
